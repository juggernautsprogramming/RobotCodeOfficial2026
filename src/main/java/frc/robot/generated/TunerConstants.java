...
public class TunerConstants {
    ...
    // Top of TunerConstants.java
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(50)    // Cut in half (was 100)
        .withKI(0)
        .withKD(0.2)   // Lowered (was 0.5) to reduce jitter
        .withKS(0)     // Set to 0 to stop the "still" grinding (was 0.1)
        .withKV(1.5)   // Standard KV for many swerve modules
        .withKA(0)
    ...
    // Pigeon2 is mounted with its arrow pointing toward the robot's BACK.
    // MountPoseYaw=180 corrects for this so heading 0° = robot front faces +X.
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(2.57);

    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot
    private static final double kCoupleRatio = 0;

    private static final double kDriveGearRatio = 12;
    private static final double kSteerGearRatio = 6.82;
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.281494140625);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.12451171875);
